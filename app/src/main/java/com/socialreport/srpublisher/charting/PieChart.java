...
*/
package com.socialreport.srpublisher.charting;
...
public class PieChart extends ViewGroup {
    ...
    private static String LOG_TAG = PieChart.class.getName();
    ...
    public PieChart(Context context) {
        ...
        Log.i(LOG_TAG, "PieChart(Context context)");
     ...
     *                {@link com.socialreport.srpublisher.R.styleable.PieChart} as well as attributes inherited
     *                from {@link View}.
     */
    public PieChart(Context context, AttributeSet attrs) {
        super(context, attrs);

        Log.i(LOG_TAG, "PieChart(Context context, AttributeSet attrs)");
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.i(LOG_TAG, "onMeasure w: " + w + " h: " + h);
    ...
    private class PointerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            Log.i(LOG_TAG, "PointerView onDraw");
